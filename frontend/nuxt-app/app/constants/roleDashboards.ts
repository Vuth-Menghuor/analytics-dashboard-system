export const managerGenderRatio = [
...
export const managerEnrollmentTrends = [
...
export const managerDepartments = [
...
export const visitorPublicDashboardCopy =
  "Limited public analytics for visitors. Manager and partner users can access deeper learning behavior, grade, quiz, assignment, and attendance data.";
